        ...
        <div class="container">
            ...
            <nav class="navbar" data-navbar>
                <ul class="navbar-list">
                    ...
                    <li>
                        <a href="./html/about.php" class="navbar-link">About<span></span></a>
                    </li>
                    ...
                    <li>
                        <a href="./html/gallery.php" class="navbar-link">Gallery<span></span></a>
                    </li>
            ...
            <a href="./api/userlogin.php" class="btn1">
...
<a href="./api/registrationappoinment.php" class="btn2"> <span class="span2">Make an appoitment</span> </a>
...
Engine repair is crucial for keeping vehicles running smoothly.
        ...
        <li>
          <div class="section_bg_card">
           ...
           Offering brake repair provides comprehensive care for customers' vehicles.
            ...
            <a href="./html/brake.php" class="btn_link_more">Read more</a>
          </div>
        </li>
 ...
 Battery repair ensuring that vehicles start reliably.
        Powering your journey, one charge at a time
            ...
            <a href="./html/battery.php" class="btn_link_more">Read more</a>
          </div>
        </li>
  ...
  Keep rolling smoothly with our tire repair services.
            ...
            <a href="./html/tire.php" class="btn_link_more">Read more</a>
          </div>
        </li>
        <li>
            <div class="section_bg_card">
...
Our steering repair service ensures smooth control for every turn of the wheel.
              ...
              <a href="./html/steering.php" class="btn_link_more">Read more</a>
            </div>
          </li>
          <li>
            <div class="section_bg_card">
        ...
        Elevate your ride with our exceptional suspension repair service.
             Smooth out every bump, ensuring a comfortable journey.
              ...
              <a href="./html/suspension.php" class="btn_link_more">Read more</a>
            </div>
          </li>
      </ul>
    </div>
          ...
          <div class="footer_container">
            ...
            <div class="footer_nav">
              <ul>
                ...
                <li><a href="./html/ourteam.php">Our Team </a></li>
